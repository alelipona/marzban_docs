...
1. Открываем настройка узлов 
  ![screenshot](../../../assets/start/node_settings/node_connect.png)
2. Переходим в меню добавление нового узла
3. Скачиваем сертификат    
  ![screenshot](../../../assets/start/node_settings/node_download.png)
4. Или, копируем его значение из меню.
